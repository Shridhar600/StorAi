...
from generation.tweet_generator import TweetGenerator
...
def run_bot(dry_run=False, is_milestone=False, test_mode=False):
    """Run the main bot process"""
    # Initialize components
    memory_store = MemoryStore()
    tweet_generator = TweetGenerator(memory_store)
...
if __name__ == "__main__":
    ...
    if args.view_memories:
        ...
        exit(0)
    # Run the bot
    tweet = run_bot(dry_run=args.dry_run, is_milestone=args.add_milestone, test_mode=args.test_mode)